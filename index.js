...
async function run() {
    try {
        ...
        app.get('/brands/:id', async (req, res) => {
            const productDetails = await brandCollection.findOne({ _id: ObjectId(req.params.id) });
        ...
        app.delete("/brands/:id", async (req, res) => {
            const deletedProduct = await brandCollection.deleteOne({ _id: ObjectId(req.params.id) });
        ...
        app.delete("/orders/:id", async (req, res) => {
            const deletedOrder = await purchaseCollection.deleteOne({ _id: ObjectId(req.params.id) });
